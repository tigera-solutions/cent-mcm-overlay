...
TARGET_K8S_CONTEXTS=("kartik+tigera-solutions@tigera.io@cc-eks-mcm2.us-east-1.eksctl.io")
...
do
    ...
    echo
    TARGET_REC=$(kubectl get rec -n $REDIS_NAMESPACE -ojsonpath='{.items..metadata.name}')
